...
def md_to_df(data: Any) -> Any:
    if isinstance(data, str):
        return (
            ...
            .iloc[1:]
            .applymap(lambda x: x.strip() if isinstance(x, str) else x)  # Apply strip only to string values
        )
    return data
        ...
        messages=[
            {
                ...
                "content": [
                    ...
                    },
                    {
                        "type": "text",
                        "text": """
                            If there is information in this image that you cannot return me, let me know please.
...
if __name__ == "__main__":
    urls = [
        "https://s3.documentcloud.org/documents/24357955/pages/1524_table_of_probation_hd_incarceration_sentences-p1-large.gif",
    ]
    for url in urls:
        tables = extract(url)
